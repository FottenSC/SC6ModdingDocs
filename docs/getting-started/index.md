...
2. [Your First Mod](first-mod.md) — scaffold a Lua mod, enable it, and confirm it logs a line on game launch.

Once both work, move on to the [UE4SS Framework](../ue4ss/index.md) section for API details, or the
